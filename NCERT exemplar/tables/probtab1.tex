...
\hhline{|-------|}
	...
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{good egg}}
\\
\hhline{~~|------|}
	 \multicolumn{2}{|p{	\gnumericColA+%
	\gnumericColB+%
	...
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{bad egg}}
\\
\hhline{|-------|}
	 \multicolumn{2}{|p{	\gnumericColA+%
	\gnumericColB+%
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\sum_{i=1}^nX_i$}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{Binomial random variable}}
\\
\hhline{|-------|}
	 \multicolumn{2}{|p{	\gnumericColA+%
	\gnumericColB+%
	...
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{Total number of eggs}}
\\
\hhline{|-------|}
	 \multicolumn{2}{|p{	\gnumericColA+%
	\gnumericColB+%
	...
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{number of bad eggs}}
\\
\hhline{|-------|}
	 \multicolumn{2}{|p{	\gnumericColA+%
	\gnumericColB+%
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{0.035}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{Probability of getting a bad eggs}}
\\
\hhline{|--|--|---|}
\end{tabular}
